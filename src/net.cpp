...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Bones " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"Bones.com", "seed.Bones.com"},
    {"209.208.111.233", "209.208.111.233"},
//    {"Bonespool.org", "dnsseed.Bonespool.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Bones is probably already running."), addrBind.ToString().c_str());
        else
